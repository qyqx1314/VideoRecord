...
//            Intent intent = new Intent(mContext.getApplicationContext(), LoginActivity_.class);
    ...
    private String saveCrashInfoToFile(Throwable ex) {
        ...
        try {
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                ...
                String path = Constants.BASE_PATH+Constants.BANGER + "/crash/";
                ...
                for (Object key : mDeviceCrashInfo.keySet()) {
                    content.append(key.toString()).append(":").append("\r\n");
                    content.append(mDeviceCrashInfo.get(key)).append("\r\n");
                }
                Log.e(TAG, "saveCrashInfoToFile: "+content.toString());
                FileUtils.writeFile(fileName, content.toString(), "UTF-8");
                return fileName;
            }
