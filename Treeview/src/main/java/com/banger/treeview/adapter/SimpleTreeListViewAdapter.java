package com.banger.treeview.adapter;
...
import com.banger.treeview.utils.adapter.TreeListViewAdapter;
...
public class SimpleTreeListViewAdapter<T> extends TreeListViewAdapter<T>
{
							   ...
							   ViewGroup parent)
	{
		...
		if (convertView == null)
		{
			convertView = mInflater.inflate(ResBean.layout_item, parent, false);
			holder = new ViewHolder();
			holder.mIcon = (ImageView) convertView
					.findViewById(ResBean.item_icon);
			holder.mText = (TextView) convertView
					.findViewById(ResBean.item_text);
